...
if __name__ == '__main__':
    ...
    def parse_args():
        ...
        parser.add_argument('--model', type=str, default='swapgan',
                            choices=['swapgan', 'acai', 'threegan',
                                     'pixel_arae', 'swapgan_pair'])
        ...
        # ---------
        parser.add_argument('--mixer', type=str, choices=['mixup', 'mixup2', 'fm'],
        ...
        parser.add_argument('--weight_decay', type=float, default=0.0,
                            help="L2 weight decay on params")
        parser.add_argument('--update_g_every', type=int, default=5)
        parser.add_argument('--classify_encoding', type=str, default=None)
    ...
    if args.classify_encoding is not None:
        tmp = args.classify_encoding.split(",")
        classify_encoding = ( int(tmp[0]), int(tmp[1]) )
    ...
    gan = gan_class(
        ...
        classify_encoding=classify_encoding,
        opt_args={'lr': args.lr,
